...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot [draw=penColor, fill=fillp,very thick] plot coordinates {(-.11,-.3) (.1,.3) (0,.8) (-.11,-.3)};

    \addplot [draw=penColor, fill=fillp,very thick] plot coordinates {(-.67,-.17) (-.53,.21) (-.6,.6) (-.67,-.17)};

    \addplot [draw=penColor, fill=fillp,very thick] plot coordinates {(.53,-.22) (.67,.16) (.6,.6) (.53,-.22)};
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot [draw=penColor, fill=fillp,very thick] plot coordinates {(-.11,-.3) (-.19,-.3) (-.08,.8) (0,.8) (-.11,-.3)};
...
\section{Solids of revolution}\index{solids of revolution}
...
\begin{tikzpicture}
  \begin{axis}[
      ...
      label/.style={at=(current axis.right of origin),anchor=west},
      axis on top, ]
    \addplot [penColor,very thick,smooth,domain=1:4,fill=fillp,draw=none] {16-19*x+8*x^2-x^3} \closedcycle;
    \addplot [penColor,very thick,smooth,domain=1:4,fill=fillp,draw=none] {-16+19*x-8*x^2+x^3} \closedcycle;

    \draw[penColor,very thick,fill=fillp] (axis cs:1,0) ellipse (20 and 400);

    \addplot [penColor,very thick,smooth,domain=1:4] {16-19*x+8*x^2-x^3};
    \addplot [penColor,very thick,smooth,domain=1:4] {-16+19*x-8*x^2+x^3};
    
    \draw[penColor,very thick,fill=fillp!50!white] (axis cs:4,0) ellipse (20 and 400);
  \end{axis}
\end{tikzpicture}
\end{image}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \draw[penColor,very thick,fill=fillp] (axis cs:2.9,0) ellipse (20 and 400);
    \draw[penColor,very thick,fill=fillp] (axis cs:3,0) ellipse (20 and 400);
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \draw[penColor,very thick,fill=fillp] (axis cs:11.5,0) ellipse (20 and 600);
    \draw[penColor,very thick,fill=fillp] (axis cs:12,0) ellipse (20 and 600);
  ...
  \begin{explanation}
    ...
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        \draw[penColor,very thick,fill=fillp] (axis cs:0,16.2) ellipse (265 and 20);
        \draw[penColor,very thick,fill=fillp] (axis cs:0,16.8) ellipse (265 and 20);
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \draw[penColor,very thick,fill=fillp] (axis cs:.48,0) ellipse (5 and 500);
    \draw[penColor2,very thick,fill=white] (axis cs:.48,0) ellipse (2.5 and 250);
    
    \draw[penColor,very thick,fill=fillp] (axis cs:.5,0) ellipse (5 and 500);
  ...
  \begin{image}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        \addplot [fillp,fill=fillp,domain=1:3, smooth] {f(x)}\closedcycle;
        \addplot [fillp,fill=fillp,domain=3:5, smooth] {f(-x+6)}\closedcycle;

        \addplot [penColor,very thick,domain=1:3, smooth] {f(x)};
        \addplot [penColor,very thick,domain=3:5, smooth] {f(-x+6)};

        \draw[penColor,very thick,fill=fillp] (axis cs:3,0) ellipse (200 and 10);
  ...
  \begin{image}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        \addplot [draw=none, fill=fillp,very thick] plot coordinates {(1,0) (1,1) (5,1) (5,0)}\closedcycle;
        \draw[penColor,very thick,fill=fillp] (axis cs:3,0) ellipse (200 and 10);

        \draw[penColor,very thick,fill=fillp] (axis cs:3,1) ellipse (200 and 10);
  ...
  \begin{image}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        \draw[draw=none,very thick,fill=fillp] (axis cs:3,1) ellipse (200 and 10);
...
%        \addplot [fillp,fill=fillp,domain=3:5, smooth] {f(-x+6)}\closedcycle;
        ...
        \draw[penColor,very thick,fill=fillp] (axis cs:3,3.6) ellipse (100 and 5);
        \draw[penColor,very thick,fill=fillp] (axis cs:3,4) ellipse (100 and 5);
