...
\begin{definition}
  Given a $2\cross2$ matrix, the \dfn{determinant} is given by:
  \[
  \det
  \begin{bmatrix}
    a & b\\
...
Typically when one computes the determinant of a $2\cross 2$ matrix,
...
\begin{definition}
  Given a $3\cross 3$ matrix, the \dfn{determinant} is given by
  \begin{align*}
  &\det\begin{bmatrix}
  a_1 &  a_2 & a_3 \\
  b_1 &  b_2 & b_3 \\
