  ...
  \begin{image}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot [ultra thick] plot coordinates {(0,0) (.97,-.25)}; %% 40 degrees
        
        \addplot [ultra thick] plot coordinates {(.97,0) (.97,-.25)}; %% 40 degrees
        \addplot [ultra thick] plot coordinates {(0,0) (.97,0)}; %% 40 degrees
