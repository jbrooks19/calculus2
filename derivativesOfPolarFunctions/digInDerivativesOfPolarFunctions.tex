...
\begin{example}
  Consider the lima\c con $r(\theta) =1+2\sin(\theta)$ on the interval $[0,2\pi]$:
  \begin{image}
     \begin{tikzpicture}
          \begin{polaraxis}[
              xtick={0,45,...,360},
  ...
  \begin{explanation}
    ...
    \end{align*}
     Thus the equation of the line (in \wordChoice{\choice{polar}\choice[correct]{rectangular}} coordinates) tangent to the lima\c con at $\theta=\pi/4$ is
     \[
...
\begin{example}
  Consider the lima\c con given by $r(\theta) =1+2\sin(\theta)$ on the
  interval $[0,2\pi]$.  Find Cartesian coordinates for the points
  where the tangent line to this lima\c con is horizontal.
\begin{explanation}
...
\begin{example}
  Again consider our friend the lima\c con given by $r(\theta)
  =1+2\sin(\theta)$ on the interval $[0,2\pi]$.  Find Cartesian
  coordinates for the points where the tangent line to this lima\c con
  is vertical.
  \begin{explanation}
  ...
  $[0,2\pi]$ has vertical tangent lines at the four points
   \begin{itemize}
   \item $(\cos(\theta),\sin(\theta)) = \left(\frac{\sqrt{(15+\sqrt{33})/2}}{4},\frac{-1+\sqrt{33}}{8}\right)$,
   \item $(\cos(\theta),\sin(\theta)) = \left(\frac{-\sqrt{(15+\sqrt{33})/2}}{4},\frac{-1+\sqrt{33}}{8}\right)$,
   \item $(\cos(\theta),\sin(\theta)) = \left(\frac{\sqrt{(15-\sqrt{33})/2}}{4},\frac{-1-\sqrt{33}}{8}\right)$, and 
   \item $(\cos(\theta),\sin(\theta)) = \left(\frac{-\sqrt{(15-\sqrt{33})/2}}{4},\frac{-1-\sqrt{33}}{8}\right)$.
   \end{itemize}
   Recalling that
   \begin{align*}
   ...
   \begin{itemize}  
   \item $(x,y) = \left(\left(1+\frac{-1+\sqrt{33}}{4}\right)\frac{\sqrt{(15+\sqrt{33})/2}}{4},\left(1+\frac{-1+\sqrt{33}}{4}\right)\frac{-1+\sqrt{33}}{8}\right)$,
   \item $(x,y) = \left(\left(1+\frac{-1+\sqrt{33}}{4}\right)\frac{-\sqrt{(15+\sqrt{33})/2}}{4},\left(1+\frac{-1+\sqrt{33}}{4}\right)\frac{-1+\sqrt{33}}{8}\right)$,
   \item $(x,y) = \left(\left(1+\frac{-1-\sqrt{33}}{4}\right)\frac{\sqrt{(15-\sqrt{33})/2}}{4},\left(1+\frac{-1-\sqrt{33}}{4}\right)\frac{-1-\sqrt{33}}{8}\right)$, and 
   \item $(x,y) = \left(\left(1+\frac{-1-\sqrt{33}}{4}\right)\frac{-\sqrt{(15-\sqrt{33})/2}}{4},\left(1+\frac{-1-\sqrt{33}}{4}\right)\frac{-1-\sqrt{33}}{8}\right)$.
   \end{itemize}
...
\wordChoice{\choice[correct]{polar}\choice{rectangular}} coordinates
