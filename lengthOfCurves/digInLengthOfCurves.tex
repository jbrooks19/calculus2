...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot [very thick, ->, dashed,] plot coordinates {(2.8,2.656) (2.8,3.586)};
    \addplot [very thick, ->, dashed,] plot coordinates {(2.4,2.656) (2.8,2.656)};
...
infinitesimal lengths. This means that the length of the curve on the interval $[a,b]$ is given by
\begin{image}
