...
Five slope fields are shown below. 
...
\begin{enumerate}
\item \wordChoice{\choice{pure time} \choice[correct]{autonomous} \choice{ neither}}
\item \wordChoice{\choice{pure time} \choice{autonomous} \choice[correct]{ neither}}
\item \wordChoice{\choice[correct]{pure time} \choice[correct]{autonomous} \choice{ neither}}
\item \wordChoice{\choice{pure time} \choice[correct]{autonomous} \choice{ neither}}
\item \wordChoice{\choice{pure time} \choice{autonomous} \choice[correct]{ neither}}
\end{enumerate}
