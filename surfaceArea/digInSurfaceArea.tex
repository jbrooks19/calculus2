...
\begin{theorem}
  ...
  \begin{explanation}
    ...
    \[
    n\cdot\left(\frac{t_{n}+b_n}{2}\right)\cdot h_n
...
\index{area!surface of revolution}
...
\begin{example}
  ...
  $[0,1]$.
  \begin{explanation}
    Let's look at a picture, with our infitesimal frustrum added:
    \begin{image}
      \begin{tikzpicture}
        \begin{axis}[
            xmin=-.5, xmax=1.5,
...
\begin{example}
  ...
  around the $y$-axis. Find its area on the interval when $0\le x\le
  1$.
  \begin{explanation}
    Let's look at a picture, with our infitesimal frustrum added:
    \begin{image}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \draw[penColor,very thick,fill=fill1!20!white] (axis cs: 0,.4) ellipse (63 and 7);
          %\draw[penColor,very thick,fill=fill1] (axis cs:2.5,0) ellipse (20 and 287.5);
          \draw[penColor,very thick,fill=fill1!50!white] (axis cs:.77,.6) arc (0:180:77 and 7);
          \draw[penColor,very thick,dashed,fill=fill1!50!white] (axis cs: .77,.6) arc (360:180:77 and 7);
    ...
    So
    \begin{align*}
      \text{Area} &= \int_0^1 2\pi x \sqrt{1 + \left(2x\right)^2} \d x\\
      &= \int_0^1 2\pi x \sqrt{1 + 4x^2} \d x\\
      &= \eval{\frac{\pi}{6}(1+4x^2)^{3/2}}_0^1\\
      &= \frac{\pi}{6}(5)^{3/2}  - \frac{\pi}{6}.
    \end{align*}
  \end{explanation}
\end{example}
