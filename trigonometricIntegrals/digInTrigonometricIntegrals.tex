...
advantage of a trigonometric identity, usually the \dfn{Pythagorean identity}:
\[
\cos^2(x) + \sin^2(x) = 1
\]
...
our sleeves.  Remember, the Pythagorean identity has two other forms:
\[
