...
\begin{definition}
	A \dfn{vector} of length $n$ is an ordered list of $n$ real numbers.  The collection of all vectors of length $n$ is called $\mathbb{R}^n$ (pronounced ``Are enn'').  The $n$ in $\mathbb{R}^n$ is called the \dfn{dimension}.
\end{definition}
